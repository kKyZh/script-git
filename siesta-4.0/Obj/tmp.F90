...
"mpiifort -g -O1 -I/opt/intel/compilers_and_libraries_2018.3.222/linux/mkl/include/intel64/lp64 -I/opt/intel/compilers_and_libraries_2018.3.222/linux/mkl/include"
character(len=*), parameter :: fppflags= &
"-DMPI -DFC_HAVE_FLUSH -DFC_HAVE_ABORT -DTRANSIESTA  -DTRANSIESTA"
